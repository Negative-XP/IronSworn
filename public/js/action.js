...
let prompt = document.getElementById('btn').addEventListener('click', newCircle)
...
function newCircle(){
	console.log('clicked')
	let segments = document.getElementById('segs').value
	let circle = new Segmentor('circle', {
		totalSegments: Number(segments),
		filledSegments: 1,
		offset: 1
	})
